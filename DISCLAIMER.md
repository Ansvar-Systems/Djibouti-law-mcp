...
- **Professional Rules**: Law Society of Djibouti members must comply with applicable professional conduct rules when using AI tools
...
This Tool aggregates data from official Djibouti legal databases. However:
...
- Djibouti law changes continuously through new statutes, amendments, and court decisions
...
This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/Djibouti-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/Djibouti-law-mcp/issues
